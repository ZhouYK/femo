...
type fnc<S, R> = <D = Partial<S>, CR = R>(data: D, customHandler?: HandleFunc<S, D>) => CR;
...
export function gluer<S = any, D = S, R = Partial<S>>(onlyOne: HandleFunc<S, D, R> | S) : GluerReturn<S, R>;
